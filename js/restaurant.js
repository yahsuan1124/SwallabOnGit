      ...
      itemsToShow.forEach(function (item) {
        ...
        var salecardHtml = `
            <div class="card position-relative">
                <div class="card-body">
                <img src="http://localhost/MySwallab/public/${
                  item.item_photo
                }" class="img-fluid">
                </div>
                ...
                <div class="mt-3" style="text-align: center;">
                    ...
                    <div class="d-flex mt-2" style="justify-content: center;">
                        <div class="fs-20 ">$</div>
                        <div class="price me-2" id="price-1" style="text-decoration: line-through;">${
                          item.item_price
                        }</div>
                        <b><i><div class="fs-20 ml-5" style="color: red;font-size: 20px;">$</div></i></b>
                        <b><i><div class="price pb-3" id="price-1" style="color: red;font-size: 20px;">${
                          item.discount_price
                        }</div></i></b>
